...
14. 결과물 : 총 3개의 결과물을 Version별로 제시해줘. 각 Version은 내용별 중요도의 가중치 변화, 구체적인 수치 유무의 차이, 결론 및 미래전망 포함 유무의 차이 등으로 차별화를 할 것""", language="plaintext")
...
15. 결과물 : 총 3개의 결과물을 Version별로 제시해줘. 각 Version은 내용별 중요도의 가중치 변화, 구체적인 수치 유무의 차이, 결론 및 미래전망 포함 유무의 차이 등으로 차별화를 할 것""", language="plaintext")

    with st.expander("3. VIS 보고서 내용 요약(개조식)"):
        st.code("""0. 사전질문 : 가장 최근에 작성된 '한양이엔지' 관련 게시물는 뭐지? 
...
13. 결과물 : 총 2개의 결과물을 Version별로 제시해줘. 각 Version은 내용별 중요도의 가중치 변화, 구체적인 수치 유무의 차이, 결론 및 미래전망 포함 유무의 차이 등으로 차별화를 할 것""", language="plaintext")
